...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-right">
                   ...
                   <li>
						<div class="dropdown">
							<button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span><?php echo "&nbsp;".$_SESSION['login_user']; ?>
								  </button>
    ...
    <!-- Page Content ____________________________________________________________________________________ -->
                    ...
                    <div class='col-sm-4 col-lg-4 col-md-4'>
                        <div class='thumbnail'>
                            ...
                            <div class='caption'>
                                ...
                                <p>it was record live at the mandalay Bay Events center.</p>
								<a class='btn btn-success'  role='button' href='addcart.php?" . $row1[0] . "'>Add to Cart </a>
							</div>
                            </br>
                        </div>
                    </div>";
